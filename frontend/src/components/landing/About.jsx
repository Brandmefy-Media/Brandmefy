    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <motion.p
          ...
          className="font-display-bold uppercase text-cream max-w-5xl"
          style={{ fontSize: "clamp(28px, 5vw, 88px)", lineHeight: 1.04, letterSpacing: "-0.02em" }}
        >
          We started at a kitchen table with coffee, chaos and a shared love for
          bold ideas. Now we are a small team doing big things.{" "}
          <span className="text-green-brand">Branding, designing, creating</span>{" "}
